        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                email: email,
                // called this way because our database is expecting to see this name as an input
                password: password
              }
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Data updated succesfully!');
            }
...
// a package that makes new features of JS to work in old browsers
// DOM ELEMENTS
